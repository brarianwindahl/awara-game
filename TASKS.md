...
- [x] **T-033 · Накшатра-агенты в Тигель**
  DoD: блок «Проводник по накшатре» в табе Баланс. 27 накшатр → 21 агент. Показывает агента, стихию, влияние.
  Файлы: `js/nakshatraAgent.js`, `tigel.html`
  Est: 10 мин
...
- [x] **T-042 · Объединение Ориентир + Натальная карта (одна кнопка)**
  DoD: кнопка «Ориентир» и модальное окно удалены из index.html. Расчёт по 9 матрицам (калейдоскоп) перенесён в natal.html после доши. Одна кнопка «НАТАЛЬНАЯ КАРТА» — всё в одном месте.
  Файлы: `index.html`, `natal.html`
  Est: 10 мин

- [x] **T-043 · Лобби: перемещение КЛЮЧ ДНЯ + 9 матриц в переключателе**
  DoD: блоки «Ключ дня» и «Серия 7 дней» перемещены вниз под переключатель матриц. Переключатель расширен с 3 до 9 матриц (3×3 сетка): Веда/Славь/Каббала/Дао/Майя/Шамбала/Гены/Египет/Юлиан.
  Файлы: `index.html`, `js/matrixSwitcher.js`
  Est: 10 мин

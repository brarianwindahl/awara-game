...
- [ ] **T-032 · Конституция (доша) из натальной карты**
  DoD: блок «Конституция (Панча-Бхута)» — 5 стихий с процентами и доминантной стихией.
...
- [ ] **T-034 · Контексты Оракула (4 режима)**
  DoD: Оракул поддерживает 4 контекста: толкование дня / наставник матрицы / зеркало выбора / архивариус.
  Файлы: `oracle.html`, `js/oracle.js`
  Est: 15 мин

- [ ] **T-035 · Safety-prompt для Оракула**

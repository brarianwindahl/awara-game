...
| Дата | 2026-05-11 (UTC) |
| Закрытые задачи | T-042, T-043 |
| Следующая задача | T-034 (контексты Оракула, см. TASKS.md) |
| Состояние master | T-028..T-037 + T-042 + T-043 merged |
...
### 2026-05-11 · brarianwindahl · T-043

- Закрыто: T-043 — лобби layout + 9 матриц в переключателе
- index.html: «Ключ дня» и «Серия» перемещены вниз под переключатель матриц
- js/matrixSwitcher.js: расширен с 3 до 9 матриц (Веда/Славь/Каббала/Дао/Майя/Шамбала/Гены/Египет/Юлиан), сетка 3×3

### 2026-05-11 · brarianwindahl · T-042

- Закрыто: T-042 — объединение Ориентир + Натальная карта
- index.html: удалена кнопка «Ориентир», модальное окно, JS-функции compass, AstroCalc объект (~760 строк)
- natal.html: добавлен блок «Калейдоскоп энергий · 9 матриц» (Ведическая/Славянская/Дао/Майя/Шамбала/Генные Ключи/Египет/Каббала/Юлианский)
- natal.html: загрузка core.js для DayData.calc()
- Одна кнопка «НАТАЛЬНАЯ КАРТА» вместо двух дублирующих
...
- T-031: oracle.html + js/oracle.js запушены в remote, кнопка ОРАКУЛ в лобби
- T-034: 4 контекста Оракула (толкование дня / наставник матрицы / зеркало выбора / архивариус)
- T-035: safety-prompt запрещает медицинские/финансовые/опасные советы
- T-036: CSS-анимации перехода между матрицами (fade, pulse, color sweep)

### 2026-05-11 · brarianwindahl · T-033

- Закрыто: T-033 — накшатра-агенты в Тигель
- js/nakshatraAgent.js: связь 27 накшатр с 21 агентом AWARA
- tigel.html: блок «Проводник по накшатре» в табе Баланс (агент, стихия, влияние)
- Автоматически появляется при наличии awara_natal_chart в localStorage
### 2026-05-11 · brarianwindahl · T-032

- Закрыто: T-032 — конституция (доша) из натальной карты
- js/dosha.js: расчёт 5 стихий (Огонь/Земля/Воздух/Вода/Эфир) из позиций планет и лагны
- natal.html: блок «Конституция (Панча-Бхута)» с полосами процентов и доминантной стихией
- localStorage: awara_dosha
- Также добавлены T-033..T-035 в TASKS.md (Phase 3b)
